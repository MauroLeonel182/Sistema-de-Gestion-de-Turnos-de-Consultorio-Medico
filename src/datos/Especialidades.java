...
public class Especialidades {
    ...
    static final String usuario = "mauro"; // Usuario que tiene acceso a la base de datos
    ...
    public static final String TABLA = "especialidades"; // Nombre de la tabla dentro de la base de datos
     ...
     * @return ArrayList
     */
    public ArrayList<Especialidad> listEspecialidades(String query) {
    ...
    public Especialidad getEspecialidad(int id) {
        ...
        if (isOkConexion()) {
            ...
            ArrayList<Especialidad> pacienteList = listEspecialidades(query);
