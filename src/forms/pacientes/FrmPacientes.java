...
public class FrmPacientes extends FrmIntern {
    ...
    private void _initTable() {
        ...
        jTable.getColumnModel().getColumn(7).setPreferredWidth(160);
        jTable.getColumnModel().getColumn(8).setPreferredWidth(160);
    }
    ...
    private Paciente _getPacienteForm() {
        ...
        c.setDomicilio(txtAddress.getText().trim()); // Añadido Domicilio
        c.setDocument(txtDocument.toEntero());
        c.setId_obrasocial(pnlComboObraSociales1._getObraSocialSelected().getId());
        c.setProvincia(txtProvince.getText().trim()); // Añadido Provincia
    ...
    private void _setForm(Paciente c) {
        ...
        txtAddress.setText(c.getDomicilio().trim()); // Añadido Domicilio
        txtDocument.setText(String.valueOf(c.getDocument()));
        pnlComboObraSociales1._setObraSocialSelected(c.getId_obrasocial());
        txtProvince.setText(c.getProvincia().trim()); // Añadido Provincia
    ...
    private void initComponents() {
        ...
        txtAddress = new texto.TxtMayusculas();
        txtProvince = new texto.TxtMayusculas();
                                ...
                                .addGroup(pnlFichaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(pnlFichaLayout.createSequentialGroup()
                                        ...
                                        .addGroup(pnlFichaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtProvince, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
                    .addGroup(pnlFichaLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        txtMovil.getAccessibleContext().setAccessibleName("");
        txtMovil.getAccessibleContext().setAccessibleParent(txtMovil);
    ...
    private texto.TxtMayusculas txtAddress;
    ...
    private texto.TxtMayusculas txtProvince;
